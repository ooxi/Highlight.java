...
public class HighlightTest {
	...
	@Test
	public void testHighlightAuto() throws ScriptException, IOException {
		...
		assert_().withFailureMessage("Failed auto highlighting asciidoc")
	...
	public void testHighlightAsciidoc() throws ScriptException, IOException {
		...
		final String test = load("asciidoc.test");
		final String expected = load("asciidoc.expect");
		final String actual = highlight.highlight(test, Languages.ASCIIDOC);
		
		assert_().withFailureMessage("Failed manually highlighting asciidoc")
			.that(actual).isEqualTo(expected);
	}
