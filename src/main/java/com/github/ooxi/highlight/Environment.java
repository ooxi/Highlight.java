...
final class Environment implements EnvironmentBinding {
	...
	private static URL findSource(String resource) {
		final URL direct = Highlight.class.getResource("/node_modules/highlight.js/lib/"+ resource);
		...
		final URL withJs = Highlight.class.getResource("/node_modules/highlight.js/lib/"+ resource +".js");
