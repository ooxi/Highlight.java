...
public class FileSubjectFactory extends SubjectFactory<FileSubject, File> {
	...
	public static final FileSubjectFactory FILES = new FileSubjectFactory();

	
	@Override
	public FileSubject getSubject(FailureStrategy fs, File subject) {
		return new FileSubject(fs, subject);
	}
